			...
			<form role="form" class="limf-settings">
				<div class="mb-4">
					...
					<p class="lead">
						...
						<br/><code>await meta.settings.get('limf');</code>
					</p>
					<div class="mb-3">
				...
				<div class="mb-4">
					...
					<div class="mb-3" data-type="sorted-list" data-sorted-list="sample-list" data-item-template="admin/plugins/limf/partials/sorted-list/item" data-form-template="admin/plugins/limf/partials/sorted-list/form">
